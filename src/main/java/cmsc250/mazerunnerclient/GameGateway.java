...
public class GameGateway implements Constants {
    ...
    public GameGateway() {
        ...
        // Win
        win1 = new Label();
        win1.setFont(new Font("Helvetica Bold", 24));
        win1.setTextFill(Color.RED);
        win1.setMinWidth(20);
        win1.setMinHeight(10);
        win1.setLayoutX(WIDTH / 2);
        win1.setLayoutY(HEIGHT / 2);
